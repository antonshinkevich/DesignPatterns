...
public class MyStringBuilder
{
    ...
    public static MyStringBuilder operator +
        (MyStringBuilder msb, string s)
    {
        msb.Append(s); // +=
        return msb;
    }
